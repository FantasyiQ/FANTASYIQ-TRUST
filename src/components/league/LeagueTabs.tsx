...
export default function LeagueTabs({ leagueId, isDynasty = true }: { leagueId: string; isCommissioner: boolean; isDynasty?: boolean }) {
    return (
        <nav className="flex gap-4 border-b border-gray-800 pb-2 overflow-x-auto" style={{ WebkitOverflowScrolling: 'touch', scrollbarWidth: 'none' }}>
            ...
            <Tab href={`/dashboard/league/${leagueId}/members`}       label="Members"          />
