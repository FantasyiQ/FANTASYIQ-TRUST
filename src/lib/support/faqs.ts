...
export const FAQ_ITEMS: FAQItem[] = [
    ...
    },
    {
        ...
        answer:   'Once the commissioner approves a payout proposal, each winner receives a unique "Claim Your Winnings" link via email and in-app notification.\n\nWinners click the link and complete a short Stripe onboarding (~5 minutes):\n1. Enter your name and last 4 digits of your SSN (required by federal KYC law)\n2. Connect your bank account\n3. FiQ automatically transfers your winnings via Stripe\n\nPayout speed depends on your commissioner. Standard Stripe deposits arrive in 2–5 business days. Some commissioners cover the 1.5% Stripe instant payout fee — if yours does, your money arrives within minutes.',
    ...
    },
    {
        ...
        answer:   'After your commissioner approves the payout proposal, you\'ll get a notification with a "Claim Your Winnings" link. Click it and you\'ll be walked through Stripe Connect onboarding:\n\n1. Click "Claim Your Winnings"\n2. Enter your name and last 4 of your SSN (federal KYC requirement)\n3. Add your bank account\n4. FiQ sends the money via Stripe\n\nPayout speed: standard deposits arrive in 2–5 business days. If your commissioner covers the 1.5% instant payout fee, funds arrive within minutes.\n\nThe link is unique to you and expires after 90 days. If you didn\'t receive it, check your email or in-app notifications.',
    ...
    },
    {
        ...
        answer:   'Payout speed depends on your commissioner:\n\n• **Standard**: 2–5 business days after you complete Stripe onboarding\n• **Instant**: Within minutes — available when your commissioner covers the 1.5% Stripe instant payout fee\n\nCheck with your commissioner to confirm which payout speed they offer. FantasyiQ Trust leagues cover the instant payout fee so winners are paid immediately.',
        tags:     ['instant', 'payout speed', 'fast', 'how long', 'days', '1.5%', 'fee', 'stripe'],
    },
    {
        id:       'dues-fees',
        category: 'dues-payouts',
        question: 'Does FiQ take a cut of dues or payouts?',
        answer:   'No. FiQ charges commissioners a flat plan fee — that\'s it. Every dollar your league collects in dues goes back out as payouts to winners. FiQ takes no percentage of dues or winnings.\n\nNote: Stripe may apply standard transfer fees when processing winner payouts via bank deposit.',
        tags:     ['fees', 'cut', 'percentage', 'dues', 'payouts', 'zero fees', 'stripe'],
    },
    {
        id:       'future-dues',
        category: 'dues-payouts',
