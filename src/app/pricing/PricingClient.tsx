...
const FEATURE_TOOLTIPS: Record<string, string> = {
    ...
    'Performance Rating Score (PRS)': 'PRS measures your long-term dynasty performance — roster strength, draft efficiency, trade impact, lineup optimization, and season-over-season improvement. It reflects dynasty skill, not just win totals.',
...
const PLAYER_PRO_FEATURES: Feature[] = [
    ...
    { name: 'Performance Rating Score (PRS)', included: true,  tooltip: tip('Performance Rating Score (PRS)') },
