...
const FEATURE_TOOLTIPS: Record<string, string> = {
    ...
    'Player Reliability Scores':     'Every FiQ member earns a PRS (0–100) based on verified seasons, league retention, helpful votes, and commissioner approvals. Know exactly who you\'re playing with.',
...
const PLAYER_PRO_FEATURES: Feature[] = [
    ...
    { name: 'Player Reliability Scores',     included: true,  tooltip: tip('Player Reliability Scores') },
