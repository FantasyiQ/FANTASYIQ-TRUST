...
const FEATURE_TOOLTIPS: Record<string, string> = {
    ...
    'Matchup Projections':           'Weekly head-to-head projections for every matchup in your league — projected scores, key players, and win probabilities based on your scoring settings.',
    ...
    'Draft Strategy':             'Pre-draft game plan built around your roster needs, league settings, and team trajectory — includes rookie rankings and round-by-round guidance.',
    'Draft Board':                'Personalized draft prep — tier-based rankings and round-by-round guidance to help you draft with confidence.',
...
const PLAYER_PRO_FEATURES: Feature[] = [
    ...
    { name: 'Matchup Projections',                     included: false, tooltip: tip('Matchup Projections') },
...
const PLAYER_ALL_PRO_FEATURES: Feature[] = [
    ...
    { name: 'Matchup Projections',                     included: true,  tooltip: tip('Matchup Projections') },
