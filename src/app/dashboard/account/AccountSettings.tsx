...
export default function AccountSettings({ name, email, emailVerified, hasPassword }: Props) {
        ...
        <div className="space-y-6">
            ...
            {hasPassword && (
                <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
                    <h2 className="font-semibold text-white mb-3">Email verification</h2>
                    {emailVerified ? (
                        ...
                        <div className="space-y-3">
                            <p className="text-sm text-gray-400">
                                Your email address has not been verified. Check your inbox for a verification link, or request a new one below.
                            </p>
                            {verifyError && (
                            ...
                            {verifySent ? (
                                ...
                                <button
                                    ...
                                    className="border border-gray-700 hover:border-gray-500 text-gray-300 hover:text-white font-medium px-4 py-2 rounded-lg transition text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                                >
