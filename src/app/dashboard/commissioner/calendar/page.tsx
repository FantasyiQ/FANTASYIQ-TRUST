        ...
        <main className="min-h-screen bg-gray-950 text-white pt-24 pb-16 px-6">
            <div className="max-w-3xl mx-auto space-y-6">
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-2xl p-10 text-center">
                    ...
                    <h2 className="text-xl font-bold mb-3">Every Key Date, One Place</h2>
                    <p className="text-gray-400 text-sm leading-relaxed max-w-md mx-auto">
                        Key dates, trade deadlines, and playoff schedules — all in one view. Never miss a waiver window, trade deadline, or draft date again.
                    </p>
                    <div className="mt-6 flex flex-wrap gap-3 justify-center text-sm text-gray-600">
                        <span className="px-3 py-1.5 bg-gray-800 rounded-lg">Trade deadlines</span>
                        <span className="px-3 py-1.5 bg-gray-800 rounded-lg">Playoff schedules</span>
                        <span className="px-3 py-1.5 bg-gray-800 rounded-lg">Draft calendar</span>
                    </div>
                </div>
            </div>
        </main>
