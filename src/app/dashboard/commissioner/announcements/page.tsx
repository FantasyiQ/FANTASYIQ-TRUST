            ...
            <div className="max-w-3xl mx-auto space-y-6">
                <div>
                    ...
                    <div className="flex items-center gap-3 mt-3">
                        <h1 className="text-2xl font-bold">Commissioner Announcements</h1>
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-2xl p-10 text-center">
                    ...
                    <h2 className="text-xl font-bold mb-3">Keep Your League Informed</h2>
                    ...
                    <div className="mt-6 flex flex-wrap gap-3 justify-center text-sm text-gray-600">
                        <span className="px-3 py-1.5 bg-gray-800 rounded-lg">League messaging</span>
                        <span className="px-3 py-1.5 bg-gray-800 rounded-lg">Rule announcements</span>
                        <span className="px-3 py-1.5 bg-gray-800 rounded-lg">Manager notifications</span>
                    </div>
                </div>
            </div>
        </main>
