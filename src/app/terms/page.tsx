        ...
        <div className="min-h-screen bg-black text-white">
            <div className="max-w-3xl mx-auto px-6 py-16 space-y-10">
                ...
                <LegalSection title="2. Nature of the Service">
                    <p>
                        FantasyiQ Trust is an <strong className="text-white">entertainment-only</strong> fantasy-football analytics platform.
                    ...
                    <p>
                        <strong className="text-white">FantasyiQ Trust does not guarantee the accuracy, completeness, or fitness for any
                    ...
                    <p>
                        FantasyiQ Trust is not affiliated with, endorsed by, or in partnership with the National Football League (NFL),
                        Sleeper, ESPN, NFL Fantasy, Yahoo Fantasy, or any other fantasy sports platform.
                    </p>
                </LegalSection>

                <LegalSection title="3. No Responsibility for Fantasy Outcomes">
                    <p>
                        FantasyiQ Trust expressly disclaims any responsibility for:
                    </p>
                    <ul>
                    ...
                    <p className="mt-2">
                        You acknowledge that fantasy sports results depend on factors entirely outside FantasyiQ Trust&apos;s control and that
                ...
                <LegalSection title="5. Third-Party Platform Compliance">
                    <p>
                        When you connect a Sleeper, ESPN, NFL Fantasy, or Yahoo Fantasy league to FantasyiQ Trust, you represent and warrant that:
                    </p>
                    <ul>
                        <li>You are authorized to access that league&apos;s data on the applicable platform</li>
                        <li>Your use of FantasyiQ Trust does not violate the Terms of Service of Sleeper, ESPN, NFL Fantasy, Yahoo Fantasy, or any other fantasy platform you connect</li>
                        <li>You will not use FantasyiQ Trust to access or process data for leagues you do not own or are not authorized to manage</li>
                    </ul>
                    <p className="mt-2">
                        You are solely responsible for ensuring your use of the Service complies with all applicable third-party terms.
                        FantasyiQ Trust is not liable for any suspension, ban, or penalty imposed by a third-party platform arising from
                ...
                <LegalSection title="6. Intellectual Property">
                    <p>
                        All intellectual property in the Service — including but not limited to the FantasyiQ Trust brand, name, logo,
                        user interface design, source code, analytical models, algorithms, and written content — is owned exclusively
                        by FantasyiQ Trust and is protected by applicable copyright, trademark, and intellectual property law.
                    </p>
                    <p>
                ...
                <LegalSection title="10. Indemnification">
                    <p>
                        You agree to indemnify, defend, and hold harmless FantasyiQ Trust and its affiliates, officers, directors,
                ...
                <LegalSection title="11. Termination">
                    <p>
                        FantasyiQ Trust reserves the right to suspend or terminate your access to the Service at any time, with or without
                        cause and with or without notice, if we believe you have violated these Terms or if we determine that continued
                        access poses a risk to the Service, other users, or FantasyiQ Trust.
                    </p>
                    <p>
                ...
                <LegalSection title="12. Subscriptions, Billing, and Refunds">
                    <p>
                        ...
                        to a Plan, you authorize FantasyiQ Trust to charge your payment method on a recurring basis at the then-current
                ...
                <LegalSection title="15. Miscellaneous">
                    <p>
                        ...
                        between you and FantasyiQ Trust with respect to the Service and supersede all prior agreements. If any provision
