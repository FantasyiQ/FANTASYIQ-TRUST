...
export default function LeagueFinderError({
    error,
    reset,
}: {
    ...
    useEffect(() => {
        captureError(error, { boundary: 'leaguefinder' });
    }, [error]);
        ...
        <main className="min-h-screen bg-gray-950 text-white pt-24 pb-16 px-6">
            <div className="max-w-md mx-auto text-center space-y-4">
                ...
                <div className="flex items-center justify-center gap-4 pt-2">
                    ...
                    <Link href="/leaguefinder" className="text-sm text-gray-400 hover:text-white transition">
                        ← League Finder
                    </Link>
                </div>
            </div>
